...
function initActors(): Array<Actor> {
	return [createActor(createVector(0, 0), { move: move_right, heal: heal }, undefined, undefined, 0),
			createActor(createVector(0, 1), { move: move_right, heal: heal }, ["healer"], undefined, 0)];
}
